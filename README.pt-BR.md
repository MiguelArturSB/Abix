...
➡️ Para uma explicação detalhada de cada comando, confira a [**Referência de Comandos**](./docs/commands.pt-BR.md).
...
➡️ Quer saber mais? Leia nosso guia [**Como o Abix Funciona**](./docs/how-it-works.pt-BR..md).
